...
try {
    execSync('npx vercel env rm GOOGLE_PRIVATE_KEY production -y', { stdio: 'inherit' });
} catch (e) { }

try {
    execSync('type temp_key.txt | npx vercel env add GOOGLE_PRIVATE_KEY production', { stdio: 'inherit' });
